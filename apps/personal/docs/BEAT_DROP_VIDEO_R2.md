...
`/media/beat-drop.mp4`, streamed out of R2 by the Pages Function
...
1. **Upload the video to R2**
   ...
   - Upload the video with the exact key `beat-drop.mp4`.
...
`/media/beat-drop.mp4` then streams from R2 and the player appears.
