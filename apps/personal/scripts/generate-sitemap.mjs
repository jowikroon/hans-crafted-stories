...
const STATIC_ROUTES = [
  ...
  { loc: `${BASE}/music/nightline`, changefreq: "yearly", priority: "0.5" },
  { loc: `${BASE}/music/slow-static`, changefreq: "yearly", priority: "0.5" },
  { loc: `${BASE}/music/paper-cranes`, changefreq: "yearly", priority: "0.5" },
  { loc: `${BASE}/music/amber`, changefreq: "yearly", priority: "0.5" },
