...
const content = {
  en: {
    ...
    intro: "I help brands sell more on Amazon Netherlands through optimized listings, data-driven advertising, and strategic account management. Documented results include 70% market share in the Amazon NL earplug category (Nielsen data), an out-of-stock rate below 2%, and 20% weekly sales growth from targeted Sponsored campaigns.",
    services: [
  ...
  nl: {
    ...
    intro: "Ik help merken meer te verkopen op Amazon Nederland door geoptimaliseerde listings, datagedreven advertenties en strategisch accountmanagement. Gedocumenteerde resultaten zijn 70% marktaandeel in de oordoppencategorie op Amazon NL (Nielsen-data), een out-of-stockpercentage onder 2% en 20% wekelijkse omzetgroei uit gerichte Sponsored-campagnes.",
    services: [
