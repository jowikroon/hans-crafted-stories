    ...
    <section className="relative section-container pt-28 pb-20 overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-0 right-0 -translate-y-1/3 translate-x-1/3 opacity-[0.03]">
        <svg width="800" height="800" viewBox="0 0 800 800" fill="none">
          ...
          {/* Chevron glyphs around outer ring */}
        ...
        <div className="mb-20 grid gap-12 md:grid-cols-5">
          ...
          >
            <div className="relative">
              {/* Stargate ring glow behind photo */}
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  download
                  className="group inline-flex items-center gap-2 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-all hover:opacity-80 hover:shadow-lg hover:shadow-foreground/10"
                >
                ...
                <a
                  ...
                  download
                  className="group inline-flex items-center gap-2 rounded-full border border-border px-5 py-2.5 text-sm font-medium text-foreground transition-all hover:bg-secondary hover:border-primary/20"
                >
