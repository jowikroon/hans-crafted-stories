...
export const translations: Record<Lang, TranslationStrings> = {
  en: {
    ...
    hero: {
      ...
      ctaWork: "Amazon NL marketplace case studies",
      ctaConsult: "Get a 7-point marketplace audit (48h reply)",
  ...
  nl: {
    ...
    hero: {
      ...
      ctaWork: "Amazon NL marktplaats case studies",
      ctaConsult: "Vraag een 7-punts marktplaats audit aan (48u reactie)",
