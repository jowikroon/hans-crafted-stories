...
- Add a workflow in `WORKFLOWS` in [src/lib/config/workflows.ts](src/lib/config/workflows.ts), e.g. `personal-agent` → `https://n8n.hansvanleeuwen.com/webhook/personal-agent`.
